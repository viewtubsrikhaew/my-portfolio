...
const BAR_PROJECT = 'https://media.base44.com/images/public/69f811de984f384ae6db76b7/7cc785b9b_image.png';
...
const ALL_PROJECTS = [
  ...
  // FINANCE — MANAGEMENT
  {
    ...
    tag: 'PRODUCT MANAGEMENT', title: 'BGFS WEB PLATFORM', year: '2025', img: 'https://media.base44.com/images/public/69f811de984f384ae6db76b7/455961dab_image.png',
    tools: ['React', 'Base44', 'SQL', 'Power BI'],
    desc: 'Built and own the Bangkok Great Future Service client-facing web app — multi-language (TH/ZH/EN) booking system, real-time seat availability, branch management, and KPI dashboard for 7 business units.',
    size: 'normal',
    imgStyle: 'object-position: top right',
  },
  {
