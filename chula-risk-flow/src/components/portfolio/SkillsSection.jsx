...
import { BarChart2, Palette, Bot, Globe } from 'lucide-react';

const TAB_ICONS = { FINANCE: BarChart2, CREATIVE: Palette, 'AI TOOLS': Bot, WEB: Globe };
...
const SKILL_DATA = {
  ...
  'AI TOOLS': {
    ...
    bars: [
      ...
      { name: 'Codex / Base44', value: 85, snippet: 'generate: component' },
    ],
    tags: [
  ...
  WEB: {
    ...
    bars: [
      { name: 'Base44', value: 88, snippet: 'base44.entities.X.list()' },
    ...
    tags: [
      ...
      { label: 'Base44 Platform', level: 'ADVANCED' },
...
const TABS = ['FINANCE', 'CREATIVE', 'AI TOOLS', 'WEB'];
