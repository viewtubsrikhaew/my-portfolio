...
const FEATURED = [
  ...
  },
  {
    ...
    tag: 'PRODUCT MANAGEMENT + OPS',
    title: 'BGFS Web Platform & Ops System',
    year: '2025',
    Icon: Globe,
    color: '#FF5F1F',
    img: 'https://media.base44.com/images/public/69f811de984f384ae6db76b7/fa9d4e4ef_image.png',
    imgStyle: 'object-position: top',
    summary: 'Product Owner + built the Bangkok Great Future Service web app — multi-language booking platform, real-time seat management, and KPI BI dashboard for 7 business units.',
    highlights: [
      'Designed & built client-facing web app (bgfs.co.th) — TH/ZH/EN multi-language booking system',
      'Real-time seat availability, branch selection, and staff management portal',
    ...
    impact: 'Product Owner — built & shipped live booking platform',
  },
  {
    id: 'gass',
    category: 'CREATIVE',
  ...
  },
  {
    ...
    emoji: '🐇',
    color: '#FFFFFF',
    img: 'https://media.base44.com/images/public/69f811de984f384ae6db76b7/946a54324_image.png',
    imgStyle: 'object-position: top',
    imgs: [
      'https://media.base44.com/images/public/69f811de984f384ae6db76b7/946a54324_image.png',
